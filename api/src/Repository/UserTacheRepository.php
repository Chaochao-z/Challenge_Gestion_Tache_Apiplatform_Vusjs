...
/**
 * @extends ServiceEntityRepository<UserTache>
 *
...
class UserTacheRepository extends ServiceEntityRepository
{
    ...
    public function save(UserTache $entity, bool $flush = false): void
    {
    ...
    public function remove(UserTache $entity, bool $flush = false): void
    {
