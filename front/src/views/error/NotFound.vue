...
<template class="error">
    <div class="d-flex justify-content-center" style="background-color: black;height: 100%">
        <div class="errordiv">
            <svg class="errorsvg" width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="text errordiv d-flex flex-column justify-content-center" style="color: white">
            <h1 class="errorh1">404 Error</h1>
