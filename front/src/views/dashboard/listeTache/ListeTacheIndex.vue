<template>
    <div class="p-5 adminIndexBox" style="width: 100%">
        <div class="d-flex justify-content-between">
            ...
            <div>
                <a href="/dashboard/listeTache/new" class="text-decoration-none text-light btn btn-info">
        ...
        <div class="adminScrollBox">
            <div v-for="tache in listeTaches" :key="listeTaches.id" class="adminBlockShow">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a :href="`/dashboard/listeTache/edit/${tache.id}`"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><path fill="#11caf0" d="m18.988 2.012l3 3L19.701 7.3l-3-3zM8 16h3l7.287-7.287l-3-3L8 13z"/><path fill="#11caf0" d="M19 19H8.158c-.026 0-.053.01-.079.01c-.033 0-.066-.009-.1-.01H5V5h6.847l2-2H5c-1.103 0-2 .896-2 2v14c0 1.104.897 2 2 2h14a2 2 0 0 0 2-2v-8.668l-2 2V19z"/></svg></a>
                        <a :href="`/dashboard/listeTache/tache/show/${tache.id}`"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24"><path fill="#11caf0" d="M12 9a3 3 0 0 0-3 3a3 3 0 0 0 3 3a3 3 0 0 0 3-3a3 3 0 0 0-3-3m0 8a5 5 0 0 1-5-5a5 5 0 0 1 5-5a5 5 0 0 1 5 5a5 5 0 0 1-5 5m0-12.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5Z"/></svg></a>
                    </div>
                </div>
            </div>
        </div>
